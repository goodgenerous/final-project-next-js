  ...
  return (
    <div className="border border-stone-500 px-2 py-8 rounded-lg mb-4">
      <Flex justifyContent="center">
        <ProfileImageSolid name={dataUser && dataUser.name} />
      </Flex>
      ...
      <Flex direction="row" padding="4" justifyContent="center" gap="6">
        <Flex direction="column" gap="2" alignItems="center">
          ...
          <Text fontSize="sm" fontWeight="semibold" color="gray.500">
            {dataUser && dataUser.hobby ? dataUser.hobby : "-"}
          </Text>
        </Flex>
        <Flex direction="column" gap="2" alignItems="center">
          <Flex direction="row" alignItems="center" gap="1">
          ...
          <Text fontSize="sm" fontWeight="semibold" color="gray.500">
            {dataUser && dataUser.phone ? dataUser.phone : "-"}
          </Text>
        </Flex>
        <Flex direction="column" gap="2" alignItems="center">
          <Flex direction="row" alignItems="center" gap="1">
          ...
          <Text fontSize="sm" fontWeight="semibold" color="gray.500">
            {dataUser && dataUser.dob ? dataUser.dob : "-"}
          </Text>
        </Flex>
      </Flex>
    </div>
